...
import { Link, useLocation, useNavigate } from 'react-router-dom';import { AiOutlineSearch, AiOutlineClose } from "react-icons/ai";
...
function Navbar() {
    ...
    const handleSearch=()=>{
        if(location.pathname!=="/searh") navigate("/search");
        else{
    ...
    <div className='flex justify-between items-center px-14 h-14 bg-[#212121] opacity-95 sticky z-50'>
        ...
        <div className="flex items-center justify-center gap-5">
            <form onSubmit={e=>{
                ...
                <div className="flex bg-zinc-900 items-center px-4 pr-0">
                    ...
                    <button className="h-10 2-16 flex items-center justify-center bg-zinc-800">
